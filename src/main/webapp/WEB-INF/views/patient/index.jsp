...
<div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white transform -translate-x-full lg:translate-x-0 transition-transform z-50">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="${pageContext.request.contextPath}/patient/dashboard" class="flex items-center px-4 py-3 bg-gray-700 rounded-xl">
            ...
            <a href="${pageContext.request.contextPath}/patient/appointments" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-xl transition">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-t border-gray-700">
            <div class="flex items-center">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <p class="text-xs text-gray-400">Patient ID: #PT12345</p>
                </div>
...
<%--                            </svg>--%>
<%--                                ${doctor.experience != null ? doctor.experience : '10'} years experience--%>
<%--                        </div>--%>
...
<%--                            </svg>--%>
<%--                                ${doctor.patientsCount != null ? doctor.patientsCount : '500'}+ patients--%>
<%--                        </div>--%>

                        <div class="flex space-x-2">
                            <button onclick="viewDoctorProfile(${doctor.id})" class="flex-1 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-xl text-sm hover:bg-blue-100 transition">
                                View Profile
                            </button>
